...
const FormImagenes = ({formik}) => {
    return ( 
        ...
        {formik.values.url1? <img src={formik.values.url1} alt="" className="self-center" height={100} width={150}/>: null}
        ...
        <div className="my-5 flex flex-col">
        {formik.values.url2? <img src={formik.values.url2} alt="" className="self-center" height={100} width={150}/>: null}
        ...
        <div className="my-5 flex flex-col">
        {formik.values.url3? <img src={formik.values.url2} alt="" className="self-center" height={100} width={150}/>: null}
